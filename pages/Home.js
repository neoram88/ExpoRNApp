...
export default class Home extends React.Component {
    ...
    handleInput1Change(e) {
        this.state.input1=parseInt(e.nativeEvent.text);
        // this.setState({input1:parseInt(e.nativeEvent.text)});
        this.calculate();
    }

    handleInput2Change(e){
        this.state.input2=parseInt(e.nativeEvent.text);
        // this.setState({input2:parseInt(e.nativeEvent.text)});
        this.calculate();
    }
    handleInput3Change(e){
        this.state.operator=e.nativeEvent.text;
    ...
    calculate(){
        ...
        if(this.state.operator=="+"){
            ...
            this.setState((prevState,props)=>({result:res}));
